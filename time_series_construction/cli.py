"""Interactive CLI for the time series construction processor."""
...
class TimeSeriesCLI:
    ...
    def run(self) -> None:
        print("Time Series Construction | ReAct + LangChain callbacks")
        ...
        while True:
            ...
            events = self.processor.process_user_response(value) if self.waiting else self.processor.process_user_request(value)
            self.waiting = False
            for event in events:
