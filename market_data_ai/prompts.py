...
from market_data_ai.agents_definition import Agent
from market_data_ai.configuration import get_config

# Detect model family from configuration to adjust prompt style.
...
_LLM_MODEL = (
    ...
    or get_config().llm.providers.get(get_config().llm.provider).model
    or ""
).casefold()
_IS_LARGE_MODEL = any(
    tag in _LLM_MODEL
