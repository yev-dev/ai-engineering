...
from time_series_autogen.agents_definition import CallbackEventType
...
def main() -> None:
    ...
    print(f"\n{'='*60}")
    print(f"TIME SERIES CONSTRUCTION WORKFLOW")
    ...
    if args.request:
        ...
        print("Example: 'Build AAPL from 2023-01-01 to 2023-12-31'")
